...
function addTask(taskText) {
  ...
  function drop(event) {
	...
	// TODO: Check if the target list is the "Add Task" box and handle accordingly
	if (targetList.id === "add-task") {
	  // Extract the task text from the dragged element
	  var taskText = draggedElement.textContent;
	  // Add task handling logic here (this will add a new task to the "Add Task" box)
	  addTask(taskText);
	}
	// TODO: Save data to the database using AJAX and update the server-side records
	saveToDatabase();
